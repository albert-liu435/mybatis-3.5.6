...
public class UnpooledDataSource implements DataSource {
  ...
  private ClassLoader driverClassLoader;//加载driver驱动类
  ...
  private synchronized void initializeDriver() throws SQLException {
    ...
    if (!registeredDrivers.containsKey(driver)) {
      ...
      try {
        ...
        Driver driverInstance = (Driver) driverType.getDeclaredConstructor().newInstance();//创建爱你Driver对象
        DriverManager.registerDriver(new DriverProxy(driverInstance));//注册驱动，DriverProxy是UnpooledDataSource的内部类，是Driver的静态代理
