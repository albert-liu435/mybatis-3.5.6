...
/**
 * 在类和属性之间的单独结果映射，属性包括id,column,property,javaType，jdbcType,type Handler,one many。id属性是一个布尔值，表示是否被用于主键映射。
 * one属性是单独的联系，和XML配置中的association相似，而many属性是对集合而言，和XML配置的collection相似
