...
class ClassLoaderWrapperTest extends BaseDataTest {
  ...
  void getResourceAsURL() {
    ...
    System.out.println(new ClassLoaderWrapper().getResourceAsURL("https://blog.csdn.net/gaomb_1990/article/details/80549514"));
    System.out.println(wrapper.getResourceAsURL(JPETSTORE_PROPERTIES));
